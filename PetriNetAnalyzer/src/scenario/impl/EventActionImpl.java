 ...
 *   <li>{@link scenario.impl.EventActionImpl#isInfinite <em>Infinite</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventActionImpl extends MinimalEObjectImpl.Container implements EventAction {
	...
	public void setInfinite(boolean newInfinite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScenarioPackage.EVENT_ACTION__INFINITE, oldInfinite, infinite));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ScenarioPackage.EVENT_ACTION__INFINITE:
				return isInfinite();
		}
