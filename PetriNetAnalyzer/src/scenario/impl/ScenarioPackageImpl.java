...
public class ScenarioPackageImpl extends EPackageImpl implements ScenarioPackage {
	 ...
	 * @generated
	 */
	public EAttribute getEventAction_Infinite() {
	...
	public void createPackageContents() {
		...
		createEAttribute(eventActionEClass, EVENT_ACTION__INFINITE);
	...
	public void initializePackageContents() {
		...
		initEReference(getEffect_EffectStateConnection(), this.getGameState(), null, "EffectStateConnection", null, 1, 1, Effect.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEventAction_Infinite(), ecorePackage.getEBoolean(), "infinite", "FALSE", 0, 1, EventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
