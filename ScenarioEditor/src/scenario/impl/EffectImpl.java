...
public class EffectImpl extends MinimalEObjectImpl.Container implements Effect {
	 ...
	 * @ordered
	 */
	protected State effectStateConnection;
	 ...
	 * @generated
	 */
	public State getEffectStateConnection() {
		if (effectStateConnection != null && effectStateConnection.eIsProxy()) {
			...
			effectStateConnection = (State)eResolveProxy(oldEffectStateConnection);
	 ...
	 * @generated
	 */
	public State basicGetEffectStateConnection() {
		return effectStateConnection;
	}
	 ...
	 * @generated
	 */
	public void setEffectStateConnection(State newEffectStateConnection) {
		State oldEffectStateConnection = effectStateConnection;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ScenarioPackage.EFFECT__EFFECT_STATE_CONNECTION:
				setEffectStateConnection((State)newValue);
				return;
			case ScenarioPackage.EFFECT__TYPE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ScenarioPackage.EFFECT__EFFECT_STATE_CONNECTION:
				setEffectStateConnection((State)null);
				return;
			case ScenarioPackage.EFFECT__TYPE:
