 ...
 * </p>
 * <ul>
 *   <li>{@link scenario.impl.GameStateImpl#isIsInitialAvailableState <em>Is Initial Available State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GameStateImpl extends StateImpl implements GameState {
	/**
	 * The default value of the '{@link #isIsInitialAvailableState() <em>Is Initial Available State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #isIsInitialAvailableState() <em>Is Initial Available State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isIsInitialAvailableState()
	 * @generated
	...
	public void setIsInitialAvailableState(boolean newIsInitialAvailableState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScenarioPackage.GAME_STATE__IS_INITIAL_AVAILABLE_STATE, oldIsInitialAvailableState, isInitialAvailableState));
	}
